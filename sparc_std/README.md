...
To create a 2D visualization:

```bash
python src/visualization/visualization_2d.py
```

To create a cosmic-styled visualization with no grid, no axes, high DPI (500), multiple glow layers, and cosmic color gradients:

```bash
python src/visualization/simple_cosmic.py
```

The cosmic visualization will be saved as `sparc_cosmic_visualization.png` with stunning visual effects.
