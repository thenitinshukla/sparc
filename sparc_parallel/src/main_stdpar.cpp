...
int main(int argc, char* argv[]) {
    ...
    std::cout << "SPARC StdPar Implementation\n";
    std::cout << "==========================\n";
    ...
    ParticleSystemStdPar ps(params.N, params.species_name.c_str(), params.species_mass);
    ...
    (void)pol; // avoid unused warning
    std::cout << "std::execution::par_unseq is supported!\n";
    ...
    // Performance metrics
    PerformanceMetricsSummary metrics = calculatePerformanceMetrics(Nt, params.N, 1, duration / 1000.0);
    printPerformanceSummary(metrics);
    
    // Save final state
    saveParticlePositions("final_positions_stdpar.txt", ps, Nt);
